...
<body>
    <div class="container">
        <h1 style="text-align: center;" class="mt-3">Webboard  soDamnCool</h1>
        ...
        charset=utf8", "root", "");
            ...
            <button type='button' onclick=edit_Func('$row[id]','$row[name]') class='btn btn-warning btn-sm me-1' data-bs-toggle='modal' 
